/*
 * Code for class ARRAYED_SET [G#1]
 */
...
extern void F965_4138(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F965_4139(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F965_4140(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F965_4141(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {ARRAYED_SET}.make_from_iterable */
void F965_4138 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 964, Current, 1, 1, 13544);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {ARRAYED_SET}.put */
void F965_4139 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 964, Current, 0, 1, 13545);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(964, Current, 13545);
	RTCC(arg1, 964, l_feature_name, 1, RTWCT(2164, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\01';
...
/* {ARRAYED_SET}.extend */
void F965_4140 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 964, Current, 0, 1, 13546);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(964, Current, 13546);
	RTCC(arg1, 964, l_feature_name, 1, RTWCT(2164, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\01';
...
/* {ARRAYED_SET}.prune */
void F965_4141 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTCC(arg1, 964, l_feature_name, 1, RTWCT(2236, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
