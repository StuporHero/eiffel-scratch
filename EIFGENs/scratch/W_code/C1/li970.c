...
extern void F970_2513(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F970_2514(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F970_7143(EIF_REFERENCE, int);
...
void F970_2513 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 969, Current, 2, 1, 13537);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(969, Current, 13537);
	RTCC(arg1, 969, l_feature_name, 1, RTWCT(2164, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F970_2514 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define arg2 arg2x.it_r
	...
	RTEAA(l_feature_name, 969, Current, 1, 2, 13538);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(969, Current, 13538);
	RTCC(arg1, 969, l_feature_name, 1, RTWCT(2164, dtype, dftype), 0x00);
	{
...
void F970_7143 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 969, Current, 0, 7142);
	RTSA(dtype);
	RTME(dtype, 0);
