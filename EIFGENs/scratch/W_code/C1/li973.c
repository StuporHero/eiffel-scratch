...
extern void F973_3594(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F973_3595(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F973_3596(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F973_3597(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F973_3594 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 972, Current, 1, 1, 13542);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(972, Current, 13542);
	{
...
/* {LINKED_SET}.put */
void F973_3595 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 972, Current, 0, 1, 13543);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(972, Current, 13543);
	RTCC(arg1, 972, l_feature_name, 1, RTWCT(2164, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\01';
...
/* {LINKED_SET}.extend */
void F973_3596 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 972, Current, 0, 1, 13540);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(972, Current, 13540);
	RTCC(arg1, 972, l_feature_name, 1, RTWCT(2164, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\01';
...
/* {LINKED_SET}.prune */
void F973_3597 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 972, Current, 0, 1, 13541);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(972, Current, 13541);
	RTCC(arg1, 972, l_feature_name, 1, RTWCT(2236, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
