...
extern EIF_TYPED_VALUE F998_7523(EIF_REFERENCE);
extern EIF_TYPED_VALUE F998_7524(EIF_REFERENCE);
extern EIF_TYPED_VALUE F998_7525(EIF_REFERENCE);
...
EIF_TYPED_VALUE F998_7523 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F998_7524 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F998_7525 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 997, Current, 0, 0, 13778);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(997, Current, 13778);
	RTIV(Current, RTAL);
	RTHOOK(1);
