...
extern EIF_TYPED_VALUE F1003_7537(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1003_7538(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1003_7539(EIF_REFERENCE);
extern void F1003_7540(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
EIF_TYPED_VALUE F1003_7537 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1002, Current, 1, 0, 13787);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1002, Current, 13787);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5300, dtype))(Current, up1x);
	RTHOOK(3);
...
RTOID (F1003_7538)
EIF_TYPED_VALUE F1003_7538 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1002, Current, 0, 0, 13788);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1002, Current, 13788);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F1003_7539)
EIF_TYPED_VALUE F1003_7539 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1002, Current, 0, 0, 13789);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1002, Current, 13789);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF80003ED, 0,0); /* Result */
...
void F1003_7540 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 1002, Current, 0, 1, 13790);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1002, Current, 13790);
...
{
	GTCX
	RTOTS (7538,F1003_7538)
	RTOTS (7539,F1003_7539)
}
