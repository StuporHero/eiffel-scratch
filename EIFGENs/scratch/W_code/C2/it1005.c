...
extern void F1005_7542(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1005_7543(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1005_7544(EIF_REFERENCE);
extern void F1005_7545(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {ITP_CONSTANT}.make */
void F1005_7542 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1004, Current, 0, 1, 13792);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1004, Current, 13792);
	RTCC(arg1, 1004, l_feature_name, 1, RTWCT(5303, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5303, 0xF8000000, 0); /* value */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
/* {ITP_CONSTANT}.value */
EIF_TYPED_VALUE F1005_7543 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1005_7544 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1004, Current, 1, 0, 13794);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1004, Current, 13794);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1005_7545 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1004, Current, 0, 1, 13795);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1004, Current, 13795);
	RTCC(arg1, 1004, l_feature_name, 1, eif_new_type(974, 0x01), 0x01);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	ur1 = RTCCL(Current);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(5056, "process_constant", arg1))(arg1, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
