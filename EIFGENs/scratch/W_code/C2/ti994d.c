...
static const EIF_TYPE_INDEX egt_13_994 [] = {0xFF01,983,0xFFFF};
...
static const struct desc_info desc_994[] = {
	...
	{EIF_GENERIC(egt_13_994), 13726, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_994), 13727, 0xFFFFFFFF},
	...
	{EIF_GENERIC(egt_15_994), 13733, 0xFFFFFFFF},
...
void Init994(void)
{
	...
	IDSC(desc_994 + 32, 435, 993);
	IDSC(desc_994 + 36, 434, 993);
	IDSC(desc_994 + 42, 428, 993);
	IDSC(desc_994 + 51, 426, 993);
}
