...
static const struct desc_info desc_1025[] = {
	...
	{EIF_GENERIC(egt_13_1025), 14222, 0xFFFFFFFF},
	...
	{EIF_GENERIC(egt_14_1025), 14230, 0xFFFFFFFF},
...
void Init1025(void)
{
	...
	IDSC(desc_1025 + 32, 394, 1024);
	IDSC(desc_1025 + 42, 217, 1024);
	IDSC(desc_1025 + 44, 418, 1024);
	IDSC(desc_1025 + 47, 395, 1024);
}
