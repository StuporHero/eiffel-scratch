...
extern EIF_TYPED_VALUE F1045_7889(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1045_7890(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1045_7891(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1045_8531(EIF_REFERENCE);
extern void EIF_Minit1045(void);
extern EIF_REFERENCE _A1045_270();
extern EIF_REFERENCE _A251_140();
extern EIF_REFERENCE _A981_39();
...
RTOID (F1045_7889)
EIF_TYPED_VALUE F1045_7889 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1044, Current, 0, 0, 14122);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1044, Current, 14122);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(5821, Dtype(tr1)))(tr1, ui4_1x);
	RTNHOOK(1,1);
...
EIF_TYPED_VALUE F1045_7890 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur5 ur5x.it_r
	...
	RTEAA(l_feature_name, 1044, Current, 8, 1, 14123);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1044, Current, 14123);
	{
		...
		RTCC(arg1, 1044, l_feature_name, 1, typres0, 0x01);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	
	{
		...
		{
			EIF_TYPE l_type;
			l_type = RTWCT(5580, dtype, dftype);
			typarr0[6] = l_type.annotations | 0xFF00;
			typarr0[7] = l_type.id;
		}
		
		typres0 = eif_compound_id(dftype, typarr0);
		tr2= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1045_270, (EIF_POINTER)(0),6058, 0, 0, 1, 1044, tr1, 0);
	}
	...
	RTHOOK(6);
	RTDBGAL(3, 0xF80003D1, 0, 0); /* loc3 */
	ur1 = RTCCL(loc2);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5579, dtype))(Current, ur1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc3 = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(7);
	tb1 = '\0';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5101, "is_exceptional", loc3))(loc3)).it_b);
	if ((EIF_BOOLEAN) !tb2) {
	...
	if (tb1) {
		if (RTAL & CK_CHECK) {
			...
			{
				static EIF_TYPE_INDEX typarr0[] = {0xFF01,0xFFF9,1,186,0xFF01,980,0xFFFF};
				EIF_TYPE typres0;
				static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
		...
		RTHOOK(10);
		RTDBGAL(4, 0xF80003D1, 0, 0); /* loc4 */
		{
			static EIF_TYPE_INDEX typarr0[] = {0xFFF9,2,186,0xFF01,250,0xFF01,0xFFF9,1,186,0xFF01,980,0xFF04,0xFFF9,1,186,0xFF01,980,0xFFFF};
			EIF_TYPE typres0;
			static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
		...
		RTHOOK(11);
		RTDBGAL(5, 0xF80003D1, 0, 0); /* loc5 */
		{
			static EIF_TYPE_INDEX typarr0[] = {0xFFF9,2,186,0xFF01,980,203,0xFFFF};
			EIF_TYPE typres0;
			static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
		...
		((EIF_TYPED_VALUE *)tr1+1)->it_r = loc8;
		RTAR(tr1,loc8);
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5101, "is_exceptional", loc4))(loc4)).it_b);
		...
		
		{
			...
			typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
			tr2= RTLNRW(typres0.id, 0, (EIF_POINTER) _A981_39, (EIF_POINTER)(0),5129, 0, 0, 1, -1, tr1, 0);
		}
		ur1 = RTCCL(tr2);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5579, dtype))(Current, ur1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		...
		RTNHOOK(12,1);
		tr3 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5826, "formatted_content", tr2))(tr2)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
		ur5 = RTCCL(tr3);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWC(5637, Dtype(tr1)))(tr1, ur1x, ur2x, ur3x, ur4x, ur5x);
		RTNHOOK(12,2);
		Result = (EIF_REFERENCE) RTCCL(tr1);
	} else {
		RTHOOK(13);
		...
		tr3 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5826, "formatted_content", tr2))(tr2)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
		ur3 = RTCCL(tr3);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWC(5625, Dtype(tr1)))(tr1, ur1x, ur2x, ur3x);
		RTNHOOK(13,2);
		Result = (EIF_REFERENCE) RTCCL(tr1);
	}
	RTHOOK(14);
	...
	RTNHOOK(18,1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(5831, "wipe_out", tr1))(tr1);
	if (RTAL & CK_ENSURE) {
		RTHOOK(19);
...
EIF_TYPED_VALUE F1045_7891 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1044, Current, 4, 1, 14124);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1044, Current, 14124);
	{
...
body:;
	...
	tr1 = RTLNTY2(RTWCT(5580, dtype, Dftype(Current)), 0x00);
	...
	loc3 = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(9);
	RTDBGAL(2, 0xF8000411, 0, 0); /* loc2 */
	tr1 = RTLN(eif_new_type(1041, 0x01).id);
	ur1 = RTCCL(loc4);
	ur2 = RTCCL(loc3);
	ur3 = NULL;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWC(5994, Dtype(tr1)))(tr1, ur1x, ur2x, ur3x);
	RTNHOOK(9,1);
	...
	tr1 = RTLNSMART(RTWCT(5579, dtype, Dftype(Current)).id);
	ur1 = RTCCL(loc2);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(5098, Dtype(tr1)))(tr1, ur1x);
	RTNHOOK(10,1);
	loc1 = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(11);
	RTTS;
...
EIF_TYPED_VALUE F1045_8531 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1044, Current, 0, 0, 14121);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1044, Current, 14121);
	RTIV(Current, RTAL);
	RTHOOK(1);
